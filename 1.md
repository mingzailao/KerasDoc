...
- keras.__init\_\_()
  ...
  ``` python
  File:        ~/github/keras/keras/__init__.py
  Source:
  ...
  基本上就是导入一些模块，首先从backend 看起。

-  keras.backend (module)

  - eras.backend.\_\_init\_\_()

    ``` python
    File:        ~/github/keras/keras/backend/__init__.py
    Source:
    from __future__ import absolute_import
    ...
    import json
    import sys
    from .common import epsilon # 数值计算精度
    from .common import floatx # float16,float32,float64
    from .common import set_epsilon #设定数值计算精度
    from .common import set_floatx #设定数值精度
    from .common import get_uid 
    from .common import cast_to_floatx #cast to 
  ...
  - keras.backend.theano_backend(module):

    ```python
    File:        ~/github/keras/keras/backend/theano_backend.py
    Source:
    import theano
